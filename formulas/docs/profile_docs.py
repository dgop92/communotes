...
class CustomProfileSchema(CustomSchemaHelper):
    ...
    retrieve_description_template = (
        "This endpoint allows you to retrieve the current user's profile"
    )
    update_description_template = (
        "This endpoint allows you to update the current user's profile"
    )
