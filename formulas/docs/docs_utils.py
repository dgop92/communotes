...
class CustomSchemaHelper:
    ...
    def __init__(self):
        self.dictionary_factory = generate_dict_factory(self.get_model_factory())
    ...
    def get_successful_list_example(self):
        ...
        return OpenApiExample(
            ...
            value={"count": 1, "next": None, "previous": None, "results": [item_data]},
            response_only=True,
            status_codes=["200"],
        )
    ...
    def get_update_description(self):
        detail_item_name = getattr(self, "detail_item_name", "No Name")
        return self.update_description_template.format(detail_item_name.split(" ")[1])
    ...
    def get_serializer(self):
        assert self.serializer is not None, (
            ...
            "or override the `get_serializer()` method." % self.__class__.__name__
        )
    ...
    def get_model_factory(self):
        assert self.model_factory is not None, (
            ...
            "or override the `get_model_factory()` method." % self.__class__.__name__
        )
    ...
    def get_list_view(self):
        assert self.list_view is not None, (
            ...
            "or override the `get_list_view()` method." % self.__class__.__name__
        )
